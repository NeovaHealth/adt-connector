...
class PatientUpdateTest extends ADTTest{
  ...
  val patientUpdateADT_31 = "MSH|^~\\&|||||20131007152356.695+0100||ADT^A31|201|T|2.4\rPID|1||987654321|9876543210^AA^^JP|BROS^MARIO^^^^||19850101000000|M|||123 FAKE STREET^MARIO \\T\\ LUIGI BROS PLACE^TOADSTOOL KINGDOM^NES^A1B2C3^JP^HOME^^1234|1234|(555)555-0123^HOME^JP:1234567|||S|MSH|12345678|||||||0|||||N"
