...
//                            s"PV1|1|I|$WARD^^^^^^^^Ward 05 Isolation|22||^^^^^^^^|^^^^^|G0000001^Dummy^Leigh^^^Dr|C2724623^Adler^B^^^Dr|420|||||||C2724623^Adler^B^^^Dr|01|" + visitID2+ "|||||||||||||||||||||||||20120110150000\r"+
  ...
  val patientUpdateADT_08H = "MSH|^~\\&|||||20131007152356.695+0100||ADT^A08|201|T|2.4\r" +
                             "EVN|A01|20120105105702||||20100105105702\r" +
                             "PID|1|^^^^PAS||"+ patientTwoId + "^\"\"^^RDD^HOSP~652 639 8685^NSTS01^^NHS^NHS~QD1320147-1^^^RDD^EVO|DUMMY^PATIENT BERYL^^^Miss||19740613000000|F||||||||||||||B^White Irish|||||||\"\"|N\r" +
  ...
  val patientDischarge = "MSH|^~\\&|iPM|iIE|T4skr|T4skr|20120122151427||ADT^A03|608741|P|2.4|||AL|AL\r" +
                            ...
                            PID2 + "\r" +
                            "PD1|||Branch Practice, Gooseberry Hill HC, Luton^GPPRC^E81046B|G3403352B^Glaze^M E^^^Dr\r"+
                            s"PV1|1|I|$WARD^^^^^^^^Ward 05 Isolation|22||^^^^^^^^|^^^^^|G0000001^Dummy^Leigh^^^Dr|C2782056^Ahmad^T^^^Mr|160|||||||C2782056^Ahmad^T^^^Mr|01|$visitID|||||||||||||||||||||||||20120115111800|20120115151300"


  val patientMergeADTNo_Identifier = "MSH|^~\\&|OTHER_IBM_BRIDGE_TLS|IBM|PAT_IDENTITY_X_REF_MGR_MISYS|ALLSCRIPTS|20090224104210-0600||ADT^A40^ADT_A39|4143361005927619863|P|2.4\r"+
                            "EVN||20090224104210-0600\r"+
                            "PID|1|||" + patientTwoId+"||OTHER_IBM_BRIDGE^MARION||19661109|F\r"+
                            "MRG|asdfasdf^^^IBOT&1.3.6.1.4.1.21367.2009.1.2.370&ISO"
